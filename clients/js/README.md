...
2. Finally, register the library with your Umi instance like so.
   ```ts
   import { bglGamePot } from '@metaplex-foundation/bgl-game-pot';
   umi.use(bglGamePot());
   ```

You can learn more about this library's API by reading its generated [TypeDoc documentation](https://bgl-game-pot-js-docs.vercel.app).
